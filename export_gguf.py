...
def get_args() -> argparse.Namespace:
    ...
    p.add_argument("--quant", type=str, default="q8_0",
    ...
    p.add_argument("--f16-for-1d", action="store_true",
                   help="Store 1-D buffers/norms in F16 even when using Q8_0")
    return p.parse_args()


def _tensor_quant_type(name: str, tensor: torch.Tensor, quant: GGMLQuantizationType, f16_for_1d: bool) -> GGMLQuantizationType:
